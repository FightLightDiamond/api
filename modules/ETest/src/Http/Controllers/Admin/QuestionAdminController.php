...
use ETest\Http\Requests\Admin\QuestionCreateRequest;
use ETest\Http\Requests\Admin\QuestionUpdateRequest;
use ETest\Http\Resources\Admin\QuestionResource;
use ETest\Http\Resources\Admin\QuestionResourceCollection;
use ETest\Http\Services\Admin\QuestionService;
...
class QuestionAdminController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            $input = $request->all();
            $question = $this->service->index($input);

            return new QuestionResourceCollection($question);
    ...
    public function update(QuestionUpdateRequest $request, $id)
    {
        $input = $request->all();
        try {
            $question = $this->service->update($input, $id);
    ...
    {
        try {
            $question = $this->service->destroy($id);
